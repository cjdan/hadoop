    ...
    public static void main(String[] args) {
        ...
        JavaRDD<Row> map = jsc.parallelize(list).map(new Function<String, Row>() {
            ...
            public Row call(String s) {
                Iterator<String> s1 = Arrays.asList(s.split(",")).iterator();
                System.out.println("s = " + s1);
                System.out.println("RowFactory.create(s1) = " + RowFactory.create(s1));
                return RowFactory.create(s1);
            }
        });
...
//                return DataTypes.createStructType(Collections.singletonList(DataTypes.createStructField("name", DataTypes.StringType, true)));
//            }
//            /**
...
//                return DataTypes.createStructType(Collections.singletonList(DataTypes.createStructField("bf", DataTypes.IntegerType, true)));
//            }
//
//        });
//
